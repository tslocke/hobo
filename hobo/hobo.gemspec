...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<hobosupport>, ["= 1.1.0.pre3"])
      s.add_runtime_dependency(%q<hobofields>, ["= 1.1.0.pre3"])
      s.add_runtime_dependency(%q<dryml>, ["= 1.1.0.pre3"])
    else
      s.add_dependency(%q<rails>, [">= 2.2.2", "< 3.0.0"])
      s.add_dependency(%q<will_paginate>, [">= 2.3.11", "~> 2"])
      s.add_dependency(%q<hobosupport>, ["= 1.1.0.pre3"])
      s.add_dependency(%q<hobofields>, ["= 1.1.0.pre3"])
      s.add_dependency(%q<dryml>, ["= 1.1.0.pre3"])
    end
  else
    s.add_dependency(%q<rails>, [">= 2.2.2", "< 3.0.0"])
    s.add_dependency(%q<will_paginate>, [">= 2.3.11", "~> 2"])
